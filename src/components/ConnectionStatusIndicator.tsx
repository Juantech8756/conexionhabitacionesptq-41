...
const ConnectionStatusIndicator = ({
  ...
  return <div className={cn("flex items-center gap-1.5 text-xs font-medium", className)}>
      ...
      {isConnected ? <span className="text-inherit">Conectado</span> : isReconnecting ? <span className="text-amber-600 animate-pulse">Reconectando...</span> : <span className="text-red-600">Desconectado</span>}
    </div>;
};
